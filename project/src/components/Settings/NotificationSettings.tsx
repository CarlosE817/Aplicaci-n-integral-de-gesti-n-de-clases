    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-md">
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Class Reminders */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Class Reminders</h3>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Get notified before your classes start</p>
                  </div>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Assignment Reminders</h3>
